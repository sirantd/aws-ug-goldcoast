 ...
 *
 * Array order is display order — Luma leads because it is where RSVPs happen.
 */
...
export const channels: Channel[] = [
  {
    name: 'Luma',
    url: 'https://luma.com/aws-ug-goldcoast',
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/company/aws-gold-coast/',
  ...
  {
    name: 'YouTube',
    url: 'https://www.youtube.com/@AWSUserGroupGoldCoast',
  ...
  {
    name: 'Meetup',
    url: 'https://www.meetup.com/awsgoldcoast/',
